...
public class TaskCommand extends Command {
     ...
     */
    protected TaskCommand(IBaritone baritone, String... names) {
    ...
    public void execute(String label, IArgConsumer args) throws CommandException {
        ...
        while(args.hasAny()) {
            item_names.add(args.getString());
        }
        baritone.getTaskBehavior().setCommand(quantity,item_names.toArray(new String[0]));
    }
